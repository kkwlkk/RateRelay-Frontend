        ...
        <div className="w-full px-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <Card className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 shadow-sm sm:hidden">
                        <CardHeader className="border-b border-zinc-100 dark:border-zinc-800">
                                        ...
                                        <div className={`flex items-start gap-4 ${user && user.username !== ticket.reporterName && user.email !== ticket.reporterName ? 'flex-row-reverse' : ''}`}>
                                            ...
                                            <div className="flex-1 space-y-3">
                                                <Textarea
                                                    ...
                                                    rows={3}
                                                    className="resize-none bg-white dark:bg-zinc-900/50 border-zinc-200 dark:border-zinc-700 focus:border-zinc-300 dark:focus:border-zinc-600 focus:ring-1 focus:ring-zinc-200 dark:focus:ring-zinc-600 transition-all duration-200"
                                                />
                ...
                <div className="space-y-6">
                    <Card className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 shadow-sm hidden sm:block">
                        <CardHeader className="border-b border-zinc-100 dark:border-zinc-800">
                            <CardTitle className="text-lg text-zinc-900 dark:text-zinc-100">Szczegóły</CardTitle>
                        </CardHeader>
