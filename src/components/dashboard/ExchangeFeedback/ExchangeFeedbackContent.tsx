...
export const ExchangeFeedbackContent = ({ mapUrl, businessName, onFormSubmit, onSkipBusiness }: ExchangeFeedbackContentProps) => {
    return (
        <div className="px-3 sm:px-4 py-6 sm:py-8 mx-auto space-y-6 sm:space-y-8">
            <BusinessCard
                ...
                mapUrl={mapUrl}
            />
            <SkipAssignedBusiness onSkipBusiness={onSkipBusiness} />
