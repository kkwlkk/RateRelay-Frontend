        ...
        <section className="border-t border-zinc-200 dark:border-zinc-800 px-5 py-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-3">
                ...
                <Button
                    ...
                    variant="ghost"
                    size="sm"
                    className="h-8 text-zinc-500 hover:text-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800/50 self-start sm:self-auto"
            ...
            <div className="p-3 sm:p-4 rounded-lg border border-blue-200 dark:border-blue-500/10 bg-blue-50 dark:bg-blue-900/10">
                <div className="flex items-start gap-2 sm:gap-3">
                    <div className="flex items-start gap-3 h-auto pt-1">
                        ...
                        <div className="flex-1 min-w-0">
                            <label
                                ...
                                className="text-sm font-medium cursor-pointer text-zinc-900 dark:text-zinc-100 flex items-start gap-1.5 leading-relaxed"
                            >
                                <FaGoogle className="h-4 w-4 text-blue-500 flex-shrink-0 mt-0.5" />
                                <span className="break-words">Wystawiłem/am również opinię w Google Maps</span>
                            </label>
                            ...
                            <div className="mt-2">
                                <Button
                                    ...
                                    className={cn(
                                        ...
                                        "rounded-md py-1.5 px-3 text-xs w-full sm:max-w-[30rem] flex items-center gap-1 justify-center",
                                ...
                                >
                                    ...
                                    <span className="truncate flex-1 text-center sm:max-w-[180px]">Przejdź do Google Maps</span>
