...
function StepCard({ icon, title, description }: StepCardProps) {
  return (
    <div className="group relative bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-800">
      ...
      <div className="relative">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6 text-lg">{description}</p>
    ...
    <section className="py-20 bg-white dark:bg-gray-950">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-800 dark:text-gray-100 mb-4">Jak to działa?</h2>
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto text-lg">W TrustRate łączymy przedsiębiorców w celu wymiany wartościowego feedbacku, który ma realny wpływ na rozwój firm. Każdy udział w tej społeczności pomaga budować zaufanie i pozytywny wizerunek lokalnych usług, wpływając na przyszłość rynku.</p>
        </div>
