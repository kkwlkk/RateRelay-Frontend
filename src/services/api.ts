...
class ApiService {
    ...
    async updateAccountSettings(data: Partial<AccountSettingsUpdateRequestDto>): Promise<ApiResponse<void>> {
        return this.request('/api/user/account/settings', 'PATCH', data);
    }
